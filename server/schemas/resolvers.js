...
const resolvers = {
  Query: {
    ...
    games: async (parent, { console, gamename }) => {
      const params = {};
      ...
      return await Game.find(params).populate('console');
    },
    game: async (parent, { _id }) => {
      return await Game.findById(_id).populate('console');
    },
    ...
    checkout: async (parent, args, context) => {
      ...
      for (let i = 0; i < gamess.length; i++) {
        const game = await stripe.gamess.create({
